...
- 上表关于LSA的介绍：
  - Type-1：路由器LSA [视频链接](https://zh.wikipedia.org/wiki/File:2_1_router_lsa_cn.ogv)
  - Type-2：网络LSA [视频链接](https://zh.wikipedia.org/wiki/File:2_2_network_lsa_cn.ogv)
  - Type-3：区域间汇总LSA [视频链接](https://zh.wikipedia.org/wiki/File:2_3_network_summary_cn.ogv)
  - Type-4：ASBR汇总LSA [视频链接](https://zh.wikipedia.org/wiki/File:2_4_ASBR_Summary_lsa_cn.ogv)
  - Type-5：外部LSA [视频链接](https://zh.wikipedia.org/wiki/File:2_5_AS_External_lsa_cn.ogv)
  - Type-7：NSSA区域专用外部LSA（由ABR转换为Type-5后传递到其他区域）
  </details>
