...
> ping通过发送[ICMP回声](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)请求报文来检验与另外一个计算机的连接
...
|<span id="tracert_j"> -j *HostList* </span>|说明发送[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)要使用IP头的松散源路由选项|
|<span id="tracert_w"> -w *Timeout* </span>|说明了等待[ICMP type0](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)的时间|
...
|<span id="pathping_g">[-g *HostList*] </span>|在[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)时使用松散源路由|
|<span id="pathping_p">[-p *Period*] </span>|说明两次ping之间的时间间隔|
|<span id="pathping_q">[-q *NumQueries*] </span>|说明发送给每个路由器的[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)的数量
|<span id="pathping_w">[-w *Timeout*] </span>|说明每次等待[ICMP type0](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)的时间
|<span id="pathping_T">[-T] </span>|对发送的[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2-IP-protocol.md#524-icmp)数据包附加上第二层优先标志（例如[802.1p](https://zh.wikipedia.org/zh-tw/IEEE_802.1p)）
