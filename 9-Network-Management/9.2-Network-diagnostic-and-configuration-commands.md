...
|<span id="tracert_j"> -j *HostList* </span>|说明发送[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)要使用IP头的松散源路由选项|
|<span id="tracert_w"> -w *Timeout* </span>|说明了等待[ICMP type0](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)的时间|
...
|<span id="pathping_g">[-g *HostList*] </span>|在[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)时使用松散源路由|
|<span id="pathping_p">[-p *Period*] </span>|说明两次ping之间的时间间隔|
|<span id="pathping_q">[-q *NumQueries*] </span>|说明发送给每个路由器的[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)的数量
|<span id="pathping_w">[-w *Timeout*] </span>|说明每次等待[ICMP type0](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)的时间
|<span id="pathping_T">[-T] </span>|对发送的[ICMP type8](https://github.com/navi0231/network-engineer-note/blob/main/5-Internet-connection/5.2.4ICMP-message-types.md)数据包附加上第二层优先标志（例如[802.1p](https://zh.wikipedia.org/zh-tw/IEEE_802.1p)）
...
===========================================================================
Interface List
 15...00 ff 4c a0 2d 11 ......TAP-Windows Adapter V9
 11...f8 75 a4 d0 11 22 ......Intel(R) Ethernet Connection (7) I219-V
